    ...
    if (prodType == ProductType.POSTRES) {
      return <ProductDessert>[
        ProductDessert(
          ...
          productDescription: "Rico flan napolitano con queso crema sencillo de preparar con pocos ingredientes que tu familia amará.", 
          productImage: 
        ...
        ProductDessert(
          ...
          productDescription: "Este pay de plátano con crema es el postre perfecto para los amantes del plátano, solo la base del pay va horneada.", 
          productImage: "https://cdn.kiwilimon.com/recetaimagen/971/th5-640x426-19783.jpg", 
          productAmount: 0
        ),
        ProductDessert(
          productTitle: "Mousse de Chocolate", 
          productDescription: "Es ideal para servir un postre fácil y delicioso a tus invitados que les sorprenderá. ", 
          productImage: "https://cdn.kiwilimon.com/recetaimagen/30250/th5-640x426-33759.jpg", 
          productAmount: 0
        ),
        ProductDessert(
          productTitle: "Gelatina de Yogurt", 
          productDescription: "La gelatina de yogurt es una receta saludable que te permite mantener la figura y al mismo tiempo comer algo delicioso y dulcecito.", 
          productImage: "https://cdn.kiwilimon.com/recetaimagen/1544/th5-640x426-12476.jpg", 
          productAmount: 0
        ),
        ProductDessert(
          productTitle: "Crepas de Cajeta", 
          productDescription: "Esta receta es de unas deliciosas crepas de cajeta con nuez hechas en casa para que disfrutes con toda tu familia. ", 
          productImage: "https://cdn.kiwilimon.com/recetaimagen/13574/th5-640x426-11710.png", 
          productAmount: 0
        )
      ];
    }
